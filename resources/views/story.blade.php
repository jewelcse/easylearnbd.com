        ...
        <div class="row listrecent listrelated">
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-block">
                        <h2 class="card-title">
                            <a href="index.blade.php">Best recreational places to visit on a holiday</a>
                        </h2>
                        <div class="metafooter">
                            <div class="wrapfooter">
									<span class="meta-footer-thumb">
										<a href="views/author.html">
                                ...
                                <span class="author-meta">
										<span class="post-name">
											<a href="views/author.html">Sal</a>
										</span>
										<br/>
                                ...
                                <span class="post-read-more">
										<a href="index.blade.php" title="Read Story">
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-block">
                        <h2 class="card-title">
                            <a href="index.blade.php">How travelling can change your life</a>
                        </h2>
                        <div class="metafooter">
                            <div class="wrapfooter">
									<span class="meta-footer-thumb">
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-block">
                        <h2 class="card-title">
                            <a href="index.blade.php">Little red dress and a perfect summer</a>
                        </h2>
                        <div class="metafooter">
                            <div class="wrapfooter">
									<span class="meta-footer-thumb">
