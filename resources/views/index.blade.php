                        ...
                        <div class="col-md-7">
                            <div class="card-block">
						        ...
						        <span class="meta-footer-thumb">
						            ...
						            <span class="post-date">{{$fStory->created_at->format('j F Y') }}</span><span class="dot"></span>
                                    <span class="post-read">{{ceil((str_word_count($fStory->body)/200))}} min read</span><span class="dot"></span>
